...
export default function Step() {
    return (
        ...
        <ul className="flex flex-col gap-y-8 justify-center items-center">
            ...
            <Link className="bg-slate-400 w-[320px] p-4 bg-slate-400 p-4 text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-full text-center me-2 mb-2 text-[22px]" to="/map">Map</Link>
        </ul>
        <Footer></Footer>
    </div>
